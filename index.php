  ...
  <section class="registration" id="pendaftaran">
    <div class="container registration-container">
      <div class="registration-info">
        ...
        <p>Biaya pendaftaran sebesar Rp 100.000,- dapat dibayarkan melalui rekening Bank BNI dengan nomor 0987654321 a.n. Sania Marwah. Atau <a href = "bayar.php">Bayar Disini</a></p>
      </div>
        ...
        <form action="simpan.php" method="post">
          ...
          <div class="form-group">
            ...
            <select id="program" name="program" required>
              ...
              <option value="IGAPIN_1(TKJ)">Teknik Komputer dan Jaringan</option>
              <option value="IGAPIN_2(RPL)">Rekayasa Perangkat Lunak</option>
              <option value="IGAPIN_3(TP)">Tehnik Permesinan</option>
              <option value="IGAPIN_4(TKR)">Tehnik Kendaraan ringan</option>
              <option value="IGAPIN_5(TBSM)">Tehnik dan Bisnis Sepeda Motor</option>
            </select>
          </div>
